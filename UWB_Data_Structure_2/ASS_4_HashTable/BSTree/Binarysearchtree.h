...
public:
    ...
    // Search the item, and based on the item info.
    ItemType * itemSearch(const ItemType & item);

    // dispaly a sideways ascii representation of tree
    void displaySidezways() const;
...
private:
    ...
    void inorderTraverseHelper(BinaryNode<ItemType> *bt, void visit(ItemType &)) const;

    //helper function for prerderTraverse to work recursively.
    void preorderTraverseHelper(BinaryNode<ItemType> *bt,
                                void visit(ItemType &)) const;

    //helper function for postorder Traverse to work recursively.
    void postorderTraverseHelper(BinaryNode<ItemType> *bt,
                                 void visit(ItemType &)) const;
