...
void BinarySearchTree<ItemType>::inorderTraverse(void visit(ItemType&)) const
{
	...
	BinarySearchTree<ItemType>::inorderTraverse(rootPtr, visit);
}

template<class ItemType>
void BinarySearchTree<ItemType>::
inorderTraverse(BinaryNode<ItemType> * bt, void visit(ItemType&)) const
{
	if (bt == nullptr)
		return;
	...
	BinarySearchTree<ItemType>::inorderTraverse(bt->getLeftChildPtr(), visit);
	visit(temp);
	BinarySearchTree<ItemType>::inorderTraverse(bt->getRightChildPtr(), visit);
}
